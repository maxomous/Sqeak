...
* 
    ...
    * face entire internals (keep offsetting till fail)
    ...
    - when to save settings?? currently just at close and on customgc's..    Event<Event_SaveSettings>::Dispatch({ }); 
    ...
    * if parallel lines, offset misses centre
    ...
    - after cancel, M5 should be sent (+any other reset commands)
