...
struct GRBLStatus_vals
{
    ...
    glm::vec3 MPos; // either MPos if WPos is given (WPos = MPos - WCO)
    glm::vec3 WPos;
    glm::vec3 WCO;  // this is recieved every 10 or 30 status messages
    int lineNum                  = 0;
...
public:
    ...
    void sendJog(const glm::vec3& p, int feedrate);
